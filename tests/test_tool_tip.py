...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.btn_last = FPushButton("上一张", self, FIcon.ARROW_CIRCLE_UP)
        ...
        self.btn_next = FPushButton("下一张", self, FIcon.ARROW_CIRCLE_DOWN)
        ...
        self.btn_left = FPushButton("左移", self, FIcon.ARROW_CIRCLE_LEFT)
        ...
        self.btn_right = FPushButton("右移", self, FIcon.ARROW_CIRCLE_RIGHT)
